lazy_static::lazy_static! {
    pub static ref T: std::collections::HashMap<&'static str, &'static str> =
        [
            ...
            ("Configure", "تنظیم"),
            ("config_acc", "بدهید \"access\" مجوز معین دسک برای کنترل از راه دور دسکتاپ باید به"),
            ("config_screen", "بدهید \"screenshot\" مجوز معین دسک برای کنترل از راه دور دسکتاپ باید به"),
            ...
            ("android_input_permission_tip1", "برای اینکه یک دستگاه راه دور بتواند دستگاه Android شما را از طریق ماوس یا لمسی کنترل کند، باید به معین دسک اجازه دهید از ویژگی \"Accessibility\" استفاده کند."),
            ("android_input_permission_tip2", "به صفحه تنظیمات سیستم زیر بروید، \"Installed Services\" را پیدا کرده و وارد کنید، سرویس \"MoeinDesk Input\" را فعال کنید"),
            ...
            ("Language", "زبان"),
            ("Keep RustDesk background service", "را در پس زمینه نگه دارید معین دسک سرویس"),
            ...
            ("config_input", "برای کنترل دسکتاپ از راه دور با صفحه کلید، باید مجوز معین دسک \"Input Monitoring\" را بدهید."),
            ("config_microphone", "را بدهید. معین دسک \"Record Audio\" برای صحبت از راه دور، باید مجوز"),
            ...
            ("still_click_uac_tip", "همچنان کاربر از راه دور نیاز دارد که روی OK در پنجره UAC اجرای معین دسک کلیک کند."),
            ...
            ("confirm_idd_driver_tip", "گزینه نصب درایور نمایش مجازی تیک خورده است. توجه داشته باشید که یک گواهی آزمایشی برای اعتماد به درایور نمایش مجازی نصب خواهد شد. این گواهی آزمایشی فقط برای اعتماد به درایورهای معین دسک استفاده خواهد شد."),
            ...
            ("verify_rustdesk_password_tip", "رمز عبور معین دسک را تأیید کنید"),
